...
use crate::client::{ControlPlaneGRPCClient, WrappedAPIClient};
...
impl WrappedAPIClient {
    pub fn get_query_result(
        ...
        resp.map(|query_info| query_result_to_py(py, query_info.into(), None))
    }
